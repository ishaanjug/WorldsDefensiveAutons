...
void Drive::control_tank(){
  ...
  // if(leftthrottle < 0){
  //   DriveL.spin(fwd, to_volt(-(leftthrottle*leftthrottle/127)), volt);
  // } else if (leftthrottle > 0) {
  //   DriveL.spin(fwd, to_volt((leftthrottle*leftthrottle/127)), volt);
  // }
  // if(rightthrottle < 0){
  //   DriveL.spin(fwd, to_volt(-(rightthrottle*rightthrottle/127)), volt);
  // } else if (rightthrottle > 0) {
  //   DriveL.spin(fwd, to_volt((rightthrottle*rightthrottle/127)), volt);
  // }
  DriveL.spin(fwd, to_volt((leftthrottle*leftthrottle*leftthrottle/127/127)), volt);
  DriveR.spin(fwd, to_volt((rightthrottle*rightthrottle*rightthrottle/127/127)), volt);
}
